    ...
    <section className="py-24 bg-brand-gray relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            <h2 className="text-[2.5rem] font-serif font-bold text-[#14151a] mb-6 tracking-tight">Trusted By 1000s</h2>
            <p className="text-[#14151a] font-medium leading-relaxed mb-6 text-[15px]">
              For more than a decade, we have been successful financial partners to people from all walks of life. Our continuing commitment to you is best reflected in the recognition and awards United Finance has received over the years.
            </p>
            <p className="text-[#14151a] font-medium leading-relaxed mb-8 text-[15px]">
              The rate of interest is prone to fluctuation basis our internal credit and risk policy, and as per an algorithmic multivariate score card.
            </p>
