    ...
    <div className="relative bg-[#a0d7d4] lg:bg-transparent min-h-[500px] flex items-center overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full pt-16 pb-24 lg:pt-24 lg:pb-32">
        ...
        >
          ...
          >
            {resolved.title || "Flexible Loans for your Business and Daily Needs"}
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            {resolved.description || "Whether you're looking to refurbish your property, buy an asset or you just need cash for working capital, we want to help you and your business succeed"}
          </motion.p>
          <motion.button 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
